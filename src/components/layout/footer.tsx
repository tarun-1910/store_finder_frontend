      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-12 mb-12 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-2 font-bold text-xl text-white hover:text-brand-highlight transition-colors duration-250 mb-4">
              <MapPin className="h-5 w-5 text-brand-highlight animate-pulse" />
        ...
        {/* Footer Bottom Strip */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-[#eae2b7]/60 pt-2">
          <div>
            &copy; {new Date().getFullYear()} StoreSutra. Discovering India's Independent Sellers.
          </div>
          <div className="flex gap-4 items-center">
            <span className="text-[#eae2b7]/40">Made with ❤️ for independent commerce.</span>
          </div>
        </div>
